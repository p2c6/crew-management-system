...
class ProfileController extends Controller
{
    ...
    {
        $this->authorize('staff-update-profile', User::class);

        $user = auth()->user();

        return Inertia::render('Staff/Profile/Index', [
    ...
    {
        $this->authorize('staff-update-personal-information', User::class);
    ...
    {
        $this->authorize('staff-update-password', User::class);
